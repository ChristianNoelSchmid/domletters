...
Christian Schmid and Bart Massey 2021
...
taken.
Thanks to the creators of the [regex](https://docs.rs/regex/1.5.4/regex/) and [rand](https://docs.rs/rand/0.8.4/rand/) crates. 
